      ...
      >
        <div className="flex flex-col items-center justify-center h-full mb-8 pt-[60px] ">
          <div className="flex flex-col mb-2 gap-x-[60px] p-5 w-full justify-center items-center">
            ...
            <p className=" max-w-[332px] lg:max-w-[350px] text-center pb-8">
              Document summarization reduces both the length and complexity of
              the text
            </p>
            <textarea
              value={formData.text}
        ...
        {summaryOpen && (
          <div className="flex flex-col items-center justify-center pb-5 mb-32">
            <div
              ref={scrollToForm}
              className=" w-[1100px] min-h-[150px] p-4 border-double border-4 border-black"
            >
              {summary && summary}
            </div>
          </div>
